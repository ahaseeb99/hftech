...
const AsideDefault: FC = () => {
  ...
  const { aside } = {...config, aside: { ...config.aside, theme: 'light'} };

  console.log("theme", aside, classes);
  ...
  return (
    <div
      id="kt_aside"
      className={clsx("aside", "aside-light")}
      data-kt-drawer="true"
    ...
    >
      ...
      <div className="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        {aside.theme === "dark" && (
          <Link to="/calendar">
            <img alt="Logo" className="h-25px logo" src={Logo} />
          </Link>
        )}
        {aside.theme === "light" && (
          <Link to="/calendar">
