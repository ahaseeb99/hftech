...
const DocumentEditModal = ({
  ...
  useEffect(() => {
    setDocType(currentEstimateDoc?.DocumentType);
  }, [currentEstimateDoc]);

  const handleEditSubmit = (e) => {
    e.preventDefault();
    currentEstimateDoc["DocumentType"] = docType;
    handleDocumentEdit(currentEstimateDoc);
    handleCloseModal();
  };
          ...
          <div className="modal-body scroll-y mx-5 my-7">
            ...
            <div className="fv-row mb-7">
              ...
              <CustomDropdown
                ...
                className=""
                value={{
                  label: currentEstimateDoc?.DocumentType,
                  value: currentEstimateDoc?.DocumentType,
                }}
