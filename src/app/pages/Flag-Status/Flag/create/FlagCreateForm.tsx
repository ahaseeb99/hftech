...
import { ACTION_createFlagAPI, ACTION_createStatusAPI } from "../../../../../store/status-flag/action";

const FlagCreateSchema = Yup.object().shape({
...
const FlagCreateForm = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: FlagCreateSchema,
  ...
  const handleSubmit = () => {
    ...
    console.log(reqData)
    dispatch(ACTION_createFlagAPI(reqData,navigate));
  };
