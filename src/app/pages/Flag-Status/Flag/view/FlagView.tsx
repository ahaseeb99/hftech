...
import { ACTION_deleteFlagAPI, ACTION_getFlagDetailAPI } from "../../../../../store/status-flag/action";
...
const FlagView = () => {
  ...
  const handleDeleteStatus = (id) => {
    dispatch(ACTION_deleteFlagAPI(id,navigate))
  }
                ...
                <Row>
                  <Col>
                    <div className="fv-row mb-7">
                      <label className="fw-bold fs-3 mb-2">Flag Name</label>
                      <p>{state?.DisplayAs}</p>
                    </div>
                  </Col>
                  <Col>
                    ...
                    <div className="d-flex">
                      {user.role.name == "ADMIN" && (
                        <button
                          ...
                          onClick={() => navigate(`/flag/update/${state._id}`)}
                        >
                          Edit
                        </button>
                      )}
