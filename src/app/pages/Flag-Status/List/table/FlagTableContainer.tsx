...
const FlagTableContainer = ({ columns, data, isLoading }: any) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
            ...
            <Row>
                ...
                {user.role.name == "ADMIN" &&
                    <div className="fv-row mb-7 col-4 d-flex justify-content-end">
                        <button className="btn btn-primary" onClick={() => navigate("/flag/create")} >Add Flag</button>
                    </div>
                }
            </Row>
                ...
                >
                    ...
                    <tbody className="text-gray-600 fw-bold" {...getTableBodyProps()}>
                        ...
                        {(page.length == 0 && !isLoading) && (
                            <tr className="text-center">
                                <td colSpan={12}>Flag not found </td>
                            </tr>
                        )}
                    </tbody>
                </table>
...
export default FlagTableContainer;