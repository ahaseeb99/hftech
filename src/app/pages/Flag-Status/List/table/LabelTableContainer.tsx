...
const LabelTableContainer = ({ columns, data, isLoading }: any) => {
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
        ...
        <div className="mb-10">
            ...
            <Row>
                ...
                {user.role.name == "ADMIN" &&
                    <div className="fv-row mb-7 col-4 d-flex justify-content-end">
                        <button className="btn btn-primary" onClick={() => navigate("/label/create")} >Add Label</button>
                    </div>
                }
            </Row>
                ...
                >
                    ...
                    <tbody className="text-gray-600 fw-bold" {...getTableBodyProps()}>
                        ...
                        {(page.length == 0 && !isLoading) && (
                            <tr className="text-center">
                                <td colSpan={12}>Status not found </td>
                            </tr>
                        )}
                    </tbody>
                </table>
...
export default LabelTableContainer