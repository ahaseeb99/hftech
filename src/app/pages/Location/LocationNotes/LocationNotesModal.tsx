...
import { ACTION_postNoteLocation } from '../../../../store/location/actions'
...
const NotesModal: React.FC<Props> = ({ show, updateNote, handleClose, LocationId, note = { "Body": "" } }) => {
  ...
  const handleSubmitNoteForm = async () => {
    ...
    dispatch(ACTION_postNoteLocation(LocationId, reqData));
    handleClose();
  };
