...
const TableContainer = (props: any) => {
  const { columns, data, onDownloadBtnHandler,setShowFilterModal, loading, inputValue, handleClearFilter } = props;
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
      ...
      <Row>
        ...
        <div className="fv-row mb-7 col-6">
          <div style={{textAlign: "right"}} className="text-right">
            ...
            <button onClick={() => setShowFilterModal(true)} type="button" className="btn btn-primary me-3"> Filter </button>
            <button onClick={() => onDownloadBtnHandler()} type="button" className="btn btn-primary">Phone List</button>
            <button onClick={() => navigate("/users/documents/list")} type="button" className="btn btn-primary ms-2">All Documents</button>
          </div>
        </div>
      </Row>
      <props.extraFilters />
        ...
        >
          ...
          <tbody className="text-gray-600 fw-bold" {...getTableBodyProps()}>
            ...
            {page?.length == 0 && !loading && (
                ...
                <td colSpan={12}>Users not found </td>
              </tr>
              )
            }
          </tbody>
